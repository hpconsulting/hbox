...
router.route('/customers')
	...
	.post(function(req, res) {
	   ...
	   customer.secure_key = req.body.secure_key.toString();
	   customer.note = req.body.note.toString();
	   ...
	   customer.lastname = req.body.lastname.toString();
	   customer.firstname = req.body.firstname.toString();
	   customer.birthday = moment(req.body.birthday);
	   customer.email = req.body.email.toString();
	   customer.newsletter = Boolean(req.body.newsletter);
	   customer.ip_registration_newsletter = req.body.ip_registration_newsletter.toString();
	   customer.newsletter_date_add = moment(req.body.newsletter_date_add);
	   customer.optin = Boolean(req.body.optin);
	   customer.website = req.body.website.toString();
	   customer.company = req.body.company.toString();
	   customer.siret = req.body.siret.toString();
	   customer.ape = req.body.ape.toString();
	   ...
	   customer.passwd = req.body.passwd.toString();
	   ...
	   customer.geoloc_postcode = req.body.geoloc_postcode.toString();
	   customer.logged = parseInt(req.body.logged);
	   customer.id_guest = parseInt(req.body.id_guest);
	   customer.groupBox = req.body.groupBox.toString();
